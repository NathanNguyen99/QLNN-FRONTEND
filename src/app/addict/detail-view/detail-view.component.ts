...
import { AddictVehicleService } from 'src/app/Shared/Services/addictVehicle.service';
...
export class DetailViewComponent implements OnInit {
  ...
  public loadAddictDrugs() {
    this.adrugsrv.getByAddictID(this.key!).subscribe(
      (data) => {
        //console.log(data);
  ...
  public loadAddictClassify() {
    this.adclassifysrv.getByAddictID(this.key!).subscribe(
      (data) => {
        //console.log(data);
  ...
  public loadAddictVehicle() {
    //this.addictDrugData$=this.adrugsrv.getByAddictID(key);
    this._addictVehicleService.getByAddictID(this.key!).subscribe(
      (data) => {
        //console.log(data);
        this.addictVehicleData = data;
      },
      (err) => console.log(err)
    );
  }
  ...
  public loadAddictPlace() {
    this.adplacesrv.getByAddictID(this.key!).subscribe(
      (data) => {
        //console.log(data);
